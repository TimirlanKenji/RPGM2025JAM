...
/*:
* @plugindesc v.1.3.6 [MZ] Advanced project testing and various settings. Made with ♥ by DKPlugins
* @author DKPlugins
...
/*:ru
* @plugindesc v.1.3.6 [MZ] Расширенное тестирование проекта и различные настройки. Сделано с ♥ от DKPlugins
* @author DKPlugins
* @url https://dk-plugins.ru
* @target MZ
* @help
